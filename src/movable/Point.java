...
public class Point implements Movable{
	...
	/**
	 * Defines the current action to perform
	 */
	public Action action=new Action(0, 0, 0);

	/**
	 * Defines a queue of actions to perform at a later time, once actions are done with they are
	 * discarded
	 */
	...
	/**
	 * The current x coordinate for the point
	 */
	protected int x;

	/**
	 * The current y coordinate for the point
	 */
	protected int y;
	 ...
	 * @param dx
	 *                  the default speed the point can travel per second in the x direction
	 * @param dy
	 *                  the default speed the point can travel per second in the y direction
	 * @param color
	...
	public Point(
		...
		//May be unnecessary now that it implements it automatically if none is provided
	...
	public void draw(final Graphics g){
		...
		//Draw a small but visible rectangle and shift the x and y to the upper left as x and y is in the center (Standard for graphics)
	 ...
	 * Creates and stores an action to be performed latter, specifically move down
	 * 
	 * @param  t
	 *                    how long to perform the action
	 * @param  factor
	 *                    The factor of dx to move (2 is twice as fast, 1 is exactly the same speed, .5
	 *                    is half, 0 is nothing)
	...
	/**
	 * Creates a new {@link Action} object to to store the action for later use<br>
	 * Creates and stores an action to be performed latter, specifically move left
	 * 
	 * @param  t
	 *                    how long to perform the action
	 * @param  factor
	...
	/**
	 * Creates a new {@link Action} object to to store the action for later use<br>
	 * Creates and stores an action to be performed latter, specifically move right
	 * 
	 * @param  t
	 *                    how long to perform the action
	 * @param  factor
	...
	/**
	 * Creates a new {@link Action} object to to store the action for later use<br>
	 * Creates and stores an action to be performed latter, specifically move up
	 * 
	 * @param  t
	 *                    how long to perform the action
	 * @param  factor
	 *                    The factor of dy to move (2 is twice as fast, 1 is exactly the same speed, .5
	 *                    is half, 0 is nothing)
	 * @return        this to allow chaining of methods
	 */
	@Override
	...
	/**
	 * Manages switching actions and for how long they are performed
	 */
	@Override
	public void next(){
		if(this.action.t==0){
